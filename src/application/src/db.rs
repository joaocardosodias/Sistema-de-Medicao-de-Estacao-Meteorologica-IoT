use sqlx::{sqlite::SqlitePoolOptions, SqlitePool, Result, Row};
use crate::models::{Leitura, NovaLeitura, Estatisticas};
...
pub async fn listar_para_grafico(pool: &SqlitePool, limite: i64) -> Result<Vec<Leitura>> {
    // Subquery: pega os N mais recentes e ordena do mais antigo para o mais novo (para o chart)
    sqlx::query_as::<_, Leitura>(
